...
background_image = cv2.imread("styling/All.png")
...
while True:
    ...
    # Resize background image to match the size of the camera frame
    ...
    if is_face_detected:
        ...
        if match_index is not None:
            ...
            # Call the calculate_work_time function with the database connection, employee ID, and today's date
    ...
    # Overlay camera frame onto resized background image
    background_image_resized[70:550, 80:720] = img[70:550, 80:720]

    # Display the resulting image
    cv2.imshow('Smart Face', background_image_resized)
